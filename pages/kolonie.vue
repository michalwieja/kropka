<template>
  <div class="site container workshops">
    ...
    <h2>Plan Dnia</h2>
    <p class="day-plan">
      <strong>7:00-8:30:</strong> Przyprowadzanie dzieci - planszówki, praktyka uważności, muzykowanie, zabawy grupowe<br>
      <strong>8:30-12:00:</strong> Warsztat I + drugie śniadanie<br>
